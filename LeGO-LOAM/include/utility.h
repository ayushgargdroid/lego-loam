...
// Waymo
// extern const int N_SCAN = 125;
// extern const int Horizon_SCAN = 175;
// extern const float ang_res_x = 1.2;
// extern const float ang_res_y = 0.76;
// extern const float ang_bottom = 74.0 + 0.1;
...
extern const float historyKeyframeFitnessScore = 0.2;  // the smaller the better alignment
